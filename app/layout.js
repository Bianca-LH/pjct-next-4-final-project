...
export const metadata = {
  title: 'watercolor',
  description: 'this is a project about watercolor...',
};
      ...
      <head>
        <body>
          ...
          <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded text-orange-600">
            ...
            <div>
              <p>
                Copyright © 2023 - All right reserved by yuyeh lin watercolor
              </p>
            </div>
          </footer>
          {/* <footer className={styles.footer}>
            2023 copyright yuyeh lin watercolor
          </footer> */}
        </body>
      </head>
    </html>
